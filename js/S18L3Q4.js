...
class Hero extends BaseCharacter {
  ...
  heal() {
    var addHp = (this.maxHp - this.hp < 30) ? this.maxHp - this.hp : 30;
    ...
    _this.id = setInterval(function() {
      ...
      if (j == 1) {
        ...
        _this.element.getElementsByClassName("hurt-text")[0].textContent = addHp;
      }

      _this.element.getElementsByClassName("effect-image")[0].src = 'images/effect/holyLight/' + j + '.png'
      j++;
